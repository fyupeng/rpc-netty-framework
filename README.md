...
- [ [#2.2.8](https://search.maven.org/artifact/cn.fyupeng/rpc-netty-framework/2.2.8/pom) ]：Optimize the issue of long parsing time for service discovery host numbers.
