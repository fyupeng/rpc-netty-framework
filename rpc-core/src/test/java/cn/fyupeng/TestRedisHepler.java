...
public class TestRedisHepler {
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        JRedisHelper.getForHostName("*******");
        log.info("开始");
        for (int i = 0; i < 1000; i++) {
            String forHostName = JRedisHelper.getForHostName("******");
            //log.info("forHostName:" + forHostName);
        }
        log.info("结束");
        LRedisHelper.getForHostName("*******");
        log.info("开始");
        for (int i = 0; i < 1000; i++) {
            String forHostName = LRedisHelper.getForHostName("*******");
            //log.info("forHostName:" + forHostName);
        }
        log.info("结束");
